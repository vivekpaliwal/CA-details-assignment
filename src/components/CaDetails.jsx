							...
							<div className="profile-container col-md-12 m-t-10 padding-20">
								...
								<div className="certification-section  col-md-12 m-t-20">
									...
									<div className="col-md-4">
										...
										<div className="certification-text m-l-10 inline-block-v-middle">										
											<div>QuickBooks</div>
											<div>
												<span>Desktop</span>
												<span> (ADVANCED)</span>
							...
							<div className="detail-container">
								...
								<div className="col-md-4 form-container">
									<div className="form-section padding-20 m-t-10">
										...
										<textarea placeholder="Send a message to introduce yourself to this advisor. Include details about yourself and the services you’re looking for." className="input-area"></textarea>
